...
GRANT ALL ON idata_gpt.* TO 'idatauser'@'%' IDENTIFIED BY 'IDatauser_1473';

#GRANT ALL ON idata_gpt.* TO 'idatauser'@'%' WITH GRANT OPTION;
...
GRANT ALL ON history.* TO 'idatauser'@'%' IDENTIFIED BY 'IDatauser_1473';

#GRANT ALL ON history.* TO 'idatauser'@'%' WITH GRANT OPTION;
...
GRANT ALL ON knowledge_management.* TO 'idatauser'@'%' IDENTIFIED BY 'IDatauser_1473';

#GRANT ALL ON knowledge_management.* TO 'idatauser'@'%' WITH GRANT OPTION;
...
GRANT ALL ON prompt_management.* TO 'idatauser'@'%' IDENTIFIED BY 'IDatauser_1473';

# GRANT ALL ON prompt_management.* TO 'idatauser'@'%' WITH GRANT OPTION;
