...
If you don’t have such file under `~/.ssh`, you will have to [generate a new key](https://huggingface.co/docs/hub/security-git-ssh#generating-a-new-ssh-keypair). Otherwise, you can [add your existing SSH public key(s) to your huggingface.co account](https://huggingface.co/docs/hub/security-git-ssh#add-a-ssh-key-to-your-account).
