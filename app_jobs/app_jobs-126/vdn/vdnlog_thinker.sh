...
hive -e "LOAD DATA INPATH 'hdfs://centos124.thinker.cn:8020/user/cloudland/vdnlogs/output/${current}/part-r-00000' INTO TABLE VDN_LOGS PARTITION (ds ='${current}');"
...
hive -e "INSERT INTO TABLE VDN_AVLB_DAILY PARTITION (ds = '${current}') SELECT v.ERR, COUNT(v.ERR) AS TOTAL, '${current}'  FROM VDN_LOGS v WHERE v.DS = '${current}' AND v.ERR IN ('208000', '303000', '301010', '301020', '301030', '301040' '304001', '304002', '304003', '304004', '601000', '602000', '100000', '110000', '301030_X') GROUP BY  v.ERR ;"
...
sqoop export --connect jdbc:mysql://114.80.177.133:3306/vdn_dashboard --table VDN_AVLB_DAILY  \
    --export-dir hdfs://centos124.thinker.cn:8020/apps/hive/warehouse/vdn_avlb_daily/ds=${current} --validate \
    --username vdnuser -password Ifeng01 --input-fields-terminated-by "\t"

	
echo "export data to MySQL table VDN_AVLB_MINUTELY .... "
sqoop export --connect jdbc:mysql://114.80.177.133:3306/vdn_dashboard --table VDN_AVLB_MINUTELY  \
    --export-dir hdfs://centos124.thinker.cn:8020/user/cloudland/vdnlogs/VDN_AVLB_MINUTELY/ds=${current} --validate \
    --username vdnuser -password Ifeng01 --input-fields-terminated-by "\t"
	

echo "export data to MySQL table VDN_AVLB_MINUTELY_REPORT .... "
sqoop export --connect jdbc:mysql://114.80.177.133:3306/vdn_dashboard --table VDN_AVLB_MINUTELY_REPORT  \
    --export-dir hdfs://centos124.thinker.cn:8020//apps/hive/warehouse/vdn_avlb_minutely_report/ds=${current} --validate \
    --username vdnuser -password Ifeng01 --input-fields-terminated-by "\t"


echo "export data to MySQL table VDN_AVLB_MINUTELY_REPORT .... "
sqoop export --connect jdbc:mysql://114.80.177.133:3306/vdn_dashboard --table VDN_FLUENT_MINUTEL_REPORT  \
    --export-dir hdfs://centos124.thinker.cn:8020//apps/hive/warehouse/vdn_fluent_minutel_report/ds=${current} --validate \
    --username vdnuser -password Ifeng01 --input-fields-terminated-by "\t"
	

echo "export data to MySQL table VDN_AVLB_MINUTELY_FULLY .... "
sqoop export --connect jdbc:mysql://114.80.177.133:3306/vdn_dashboard --table VDN_AVLB_MINUTELY_FULLY  \
    --export-dir hdfs://centos124.thinker.cn:8020/user/cloudland/vdnlogs/VDN_AVLB_MINUTELY_FULLY/ds=${current} --validate \
    --username vdnuser -password Ifeng01 --input-fields-terminated-by "\t"	
	
echo "export data to MySQL table VDN_AVLB_MINUTELY_FULLY_REPORT .... "
sqoop export --connect jdbc:mysql://114.80.177.133:3306/vdn_dashboard --table VDN_AVLB_MINUTELY_FULLY_REPORT  \
    --export-dir hdfs://centos124.thinker.cn:8020/user/cloudland/vdnlogs/VDN_AVLB_MINUTELY_FULLY_REPORT/ds=${current} --validate --input-null-string '\\N'  --input-null-non-string '\\N' \
    --username vdnuser -password Ifeng01 --input-fields-terminated-by "\t"	

	
echo "export data to MySQL table VDN_AVLB_MINUTELY_FULLY_GATHER .... "
sqoop export --connect jdbc:mysql://114.80.177.133:3306/vdn_dashboard --table VDN_AVLB_MINUTELY_FULLY_GATHER  \
    --export-dir hdfs://centos124.thinker.cn:8020/user/cloudland/vdnlogs/VDN_AVLB_MINUTELY_FULLY_GATHER/ds=${current} --validate --input-null-string '\\N'  --input-null-non-string '\\N' \
    --username vdnuser -password Ifeng01 --input-fields-terminated-by "\t"	
