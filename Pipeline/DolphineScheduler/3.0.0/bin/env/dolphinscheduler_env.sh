...
export SPRING_DATASOURCE_URL=jdbc:mysql://data-thinker-0:3306/dlink_pipeline?useUnicode=true&characterEncoding=UTF-8&useSSL=false
...
export REGISTRY_ZOOKEEPER_CONNECT_STRING=${REGISTRY_ZOOKEEPER_CONNECT_STRING:-"data-thinker-4:2181,data-thinker-6:2181,data-thinker-7:2181"}

# Tasks related configurations, need to change the configuration if you use the related tasks.
export HADOOP_HOME=${HADOOP_HOME:-/usr/hdp/3.1.4.0-315/hadoopp}
export HADOOP_CONF_DIR=${HADOOP_CONF_DIR:-/etc/hadoop/conf}
export SPARK_HOME1=${SPARK_HOME1:-/usr/hdp/3.1.4.0-315/spark2}
