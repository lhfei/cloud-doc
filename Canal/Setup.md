...
```sql
-- Create DB
CREATE DATABASE IF NOT EXISTS monitor_manager;
CREATE DATABASE IF NOT EXISTS monitor_tsdb;

CREATE USER 'monitor'@'localhost' IDENTIFIED BY 'NxMonitor_1473';

GRANT ALL ON monitor_manager.* TO 'monitor'@'%' IDENTIFIED BY 'NxMonitor_1473';
GRANT ALL ON monitor_tsdb.* TO 'monitor'@'%' IDENTIFIED BY 'NxMonitor_1473';
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `monitor_manager` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
