      ...
      export JAVA_HOME=/export/cloud/jdk1.8.0_271
      export HADOOP_HOME_WARN_SUPPRESS=1

      # Hadoop home directory
      export HADOOP_HOME=${HADOOP_HOME:-/export/cloud/hadoop-3.2.1}
      ...
      export HADOOP_OPTS="-Djava.library.path=$JAVA_LIBRARY_PATH $HADOOP_OPTS"
