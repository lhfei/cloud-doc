...
```shell
for i in /usr/sampledata/*.zip; do echo $i; unzip -cq $i '*.csv' | sed 's/\.00//g' | clickhouse-client -m -u default --password Lhfei -h 10.182.57.104 --query="INSERT INTO benchmark.ontime FORMAT CSVWithNames"; done
```
